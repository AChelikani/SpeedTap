...
Crafty.c("Delay", {
    init: function () {
        ...
        this.bind("Pause", function () {
            ...
            var objNow = document.getElementById('nowOnPause');
            var objPauseBuffer = document.getElementById('pauseBufferOnPause');
            
            var now = new Date().getTime();
            objNow.innerHTML = now;        
                        
            for (var index in this._delays) {
                
                this._delays[index].pauseBuffer = now;
                objPauseBuffer.innerHTML = this._delays[index].pauseBuffer;
        ...
        this.bind("Unpause", function () {
            ...
            var objNow = document.getElementById('nowOnUnPause');
            var objPauseBuffer = document.getElementById('pauseBufferOnUnPause');
            ...
            for (var index in this._delays) {
                ...
                objPauseBuffer.innerHTML = item.pause;
